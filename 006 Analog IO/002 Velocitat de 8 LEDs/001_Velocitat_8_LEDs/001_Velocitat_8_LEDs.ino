...
**                                                                               **
**                                     TÍTOL:                                    **
**                            001 Velocitat de 8 LEDs                            **
**                                                                               **
**  NOM: Àlex Boluda Pérez                                      DATA: 12/01/2022 **
**********************************************************************************/
...
void loop()
{
  ...
  Serial.println(valPot0);         // actualitzar velocitat amb el valor del potenciòmetre
  
  velocitat = 10 + valPot0;        // anirà de 10 a 1034ms
